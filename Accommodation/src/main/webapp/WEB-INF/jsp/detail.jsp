...
<div class="page">
    ...
    <!-- <section class="section swiper-container swiper-slider swiper-slider-minimal" data-loop="true" data-slide-effect="fade" data-autoplay="4759" data-simulate-touch="true">
      <div class="swiper-wrapper">
        <div class="swiper-slide swiper-slide_video" data-slide-bg="images/nhatro.jpg">
          <div class="container">
        ...
        <div class="swiper-slide" data-slide-bg="images/nhatro.jpg">
          <div class="container">
            <div class="jumbotron-classic-content">
              <div class="wow-outer">
    ...
    <section class="section novi-background section-md text-center">
        <c:forEach var="accommodation" items="${accommodation}">
        <div class="container" style="margin-top:0px">
            <h3 class="text-uppercase font-weight-bold wow-outer"><span class="wow slideInDown">${accommodation.title}</span>
            </h3>
            <div class="row row-lg-50 row-35 offset-top-2">
                <div class="container">
                    <table class="table">
                        <thead>
                        <tr>
                            <th scope="col"><b>Người đăng</b></th>
                        ...
                        <tr>
                            ...
                            <td>${accommodation.preferClient}</td>
                            <td>${accommodation.size}m vuông</td>
                            <td>${accommodation.price}/tháng</td>
                            <td>${accommodation.user.contact}</td>
                        </tr>
                        </tbody>
                    </table>
                    <h3 class="text-uppercase font-weight-bold wow-outer"><span
                            class="wow slideInDown">Thông tin mô tả</span></h3>
                    <!-- <div class="row row-lg-50 row-35 offset-top-2">      -->
                </div>
                ...
                <div class="container" style="border: 1px solid #CDCDCD;margin-top: -50px">
                    <br>
                    <p align="left">
                ...
                <div class="container" style="border: 1px solid #CDCDCD;margin-top: -50px">
                    <h3 class="text-uppercase font-weight-bold wow-outer"><span class="wow slideInDown">Hình ảnh</span>
                    </h3>
                    ...
                    <div class="row row-lg-50 row-35 offset-top-2">
                        <div class="col-md-6 wow-outer">
                            ...
                            <article class="post-modern wow slideInLeft"><a class="post-modern-media" href="#"><img
                                    src="../../public/images/${accommodation.image}" style="margin-bottom: 5px" alt="" width="571" height="353"/></a>
                            </article>
                            <!-- Post Modern-->
                            <article class="post-modern wow slideInLeft"><a class="post-modern-media" href="#"><img
                                    src="../../public/images/${accommodation.image}" alt="" width="571" height="353"/></a>
                            </article>
                        </div>
                        <!-- Post Modern-->
                        <article class="post-modern wow slideInLeft"><a class="post-modern-media" href="#"><img
