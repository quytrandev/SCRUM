...
<div class="container" >
    <h3 class="wthree_text_info" style="background-color: white;padding-top: 50px;color: black">Footwear<span></span></h3>
</div>
<c:if test="${role=='manager'}">
    <div style="padding-left: 1351px ;padding-top: 10px">
        <td class="text-center"><spring:url value="/product/addProduct/" var="addURL"/> <a class="btn btn-link"
            ...
            <div class="resp-tabs-container" >
                ...
                <div class="tab1">
                    <c:forEach items="${productsList}" var="product" >
                        <c:if test="${product.unit=='footwear'}">
                                ...
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div>
                                        <div class="item-info-product" >
                                            ...
                                            <c:if test="${role=='manager'}">
                                                <td><spring:url value="/product/updateProduct/${product.id}"
                                                                var="updateURL" /> <a class="btn btn-primary btn-lg active"
                                                                                      href="${updateURL }" role="button">Update</a></td>
                                                <td><spring:url value="/product/deleteProduct/${product.id}"
